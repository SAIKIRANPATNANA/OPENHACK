...
def upload_file():
    try:
        ...
        try:
            ...
            # Generate plots for all abnormal parameters
            ...
            # Generate new plots
            try:
                helper.create_blood_test_plots(parsed_report, output_folder=plots_dir)
            except helper.ParseError as e:
                print(f"Warning: Plot generation failed: {str(e)}")
                # Continue with the response even if plot generation fails
